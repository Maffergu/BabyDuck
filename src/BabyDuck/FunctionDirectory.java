...
public class FunctionDirectory {
    ...
    public static class FunctionInfo {
        ...
        /**
         * Establece la tabla de variables locales para esta función.
         * Esto es útil cuando la tabla se crea externamente (ej. en GeneradorCuadruplos)
         * y luego se asigna a la FunctionInfo.
         * @param localVariables La VariableTable que contiene las variables locales de esta función.
         */
    ...
    public void printDirectory() {
        System.out.println("--- Function Directory ---");
        ...
        for (Map.Entry<String, FunctionInfo> entry : functions.entrySet()) {
            ...
            System.out.println(info.toString()); // Asume que FunctionInfo tiene un buen toString()
            System.out.println("-------------------------");
        }
    }
    /**
